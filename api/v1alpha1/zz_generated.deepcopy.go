...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretMountSource) DeepCopyInto(out *SecretMountSource) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretMountSource.
func (in *SecretMountSource) DeepCopy() *SecretMountSource {
	if in == nil {
		return nil
	}
	out := new(SecretMountSource)
